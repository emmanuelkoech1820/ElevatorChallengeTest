...
{
    public class Elevatormanager : ElevatorMotion, IElevatorManager
    {
        /// </summary>
        ...
        /// Default constructor
        /// </summary>
        public Elevatormanager(int elevatorIndex, ElevatorConfiguration elevatorConfiguration)
        {
        ...
        public Elevatormanager(ElevatorStatus initStatus, ElevatorConfiguration elevatorConfiguration)
        {
